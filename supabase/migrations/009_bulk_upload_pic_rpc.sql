-- ============================================================
-- EXATA Client Access — Migrasi 009: Bulk Upload RPC with PIC
-- ============================================================

-- Hapus fungsi lama yang tidak memiliki p_pic_id agar tidak bentrok
DROP FUNCTION IF EXISTS finalize_bulk_client_upload(TEXT, DATE, UUID, UUID, JSONB, TEXT, TEXT, TIMESTAMPTZ, INET, TEXT);
...
BEGIN
    ...
    IF v_client_id IS NULL THEN
        ...
        VALUES (trim(p_client_name), p_client_dob, p_pic_id)
